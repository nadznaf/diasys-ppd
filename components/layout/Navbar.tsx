        ...
        if (pathname === "/login") {
            return (
                <Button
                    ...
                    className="bg-indigo-600 hover:bg-indigo-700 hover:scale-105 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-lg font-semibold flex items-center gap-2 transition-all duration-300"
                >
                    Register
                </Button>
            );
            ...
            return (
                <div className="relative" ref={dropdownRef}>
                    <button
                        ...
                        className="my-auto text-base sm:text-xl md:text-2xl font-bold text-black hover:text-indigo-600 transition-colors duration-300 flex items-center gap-2"
                    >
                        <span className="hidden sm:inline">Hai, {userName}!</span>
                        <span className="sm:hidden">{userName}</span>
                        <svg
                            className={`w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-300 ${showDropdown ? "rotate-180" : ""
                                }`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                    ...
                    {/* Dropdown Menu */}
                    {showDropdown && (
                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 border border-gray-200 animate-fade-in">
                            <button
                ...
                <div className="flex justify-between items-center px-4 sm:px-6 md:px-12 lg:px-36 py-4 md:py-6 lg:py-8">
                    <Link href="/" className="transition-transform hover:scale-105 duration-300">
                        <Image
                            ...
                            width={110}
                            height={48}
                            className="sm:w-[139px] sm:h-[60px]"
                        />
                    </Link>
